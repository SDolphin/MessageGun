...
namespace TLSharp.Core
{
    ...
    {
        private static string defaultConnectionAddress = "149.154.175.100";//"149.154.167.50";
        private static int defaultConnectionPort = 443;

        public static string ConnectionAdress
        {
            get => defaultConnectionAddress;
            set => defaultConnectionAddress = value;
        }

        public static int ConnectionPort
        {
            get => defaultConnectionPort;
            set => defaultConnectionPort = value;
        }
